...
module gpu(slots = 2) {
    ...
    module pcb() {
        color("#0F0F0F") difference() {
            cube([ gpu_pcb_thickness, gpu_pcb_length, gpu_pcb_height ]);
            translate([ 0 - 0.01, 7.5, 82 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 3.18);
            }
            { // Cooler Mounting holes
                ...
                translate([
                    0 - 0.01, hole_base_x + hole_dis_x, hole_base_y + hole_dis_y
                ]) {
                    rotate([ 0, 90, 0 ]) {
                        cylinder(h = gpu_pcb_thickness + 0.02, d = 3.18);
                    }
        ...
        color("#0F0F0F") difference() {
            translate([ 0, 0, -8.25 ]) {
                cube([ gpu_pcb_thickness, 15, 8.25 ]);
            }
        ...
        color("#0F0F0F") translate([ 0, 33.35, -8.25 ]) difference() {
            cube([ gpu_pcb_thickness, 11.65, 8.25 ]);
            translate([ 0 - 0.01, 8, 0 - 0.01 ]) {
                cube([ gpu_pcb_thickness + 0.02, 3.65, 6.425 + 0.02 ]);
            }
            translate([ 0 - 0.01, 9.825, 6.425 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 3.65);
            }
        }

        color("#0F0F0F") translate([ 0, 45, -12.75 ]) difference() {
            cube([ gpu_pcb_thickness, 99.75, 12.75 ]);

            translate([ 0 - 0.01, 0.25, -0.25 ]) rotate([ 45, 0, 0 ]) {
                cube([ gpu_pcb_thickness + 0.02, sqrt(2) / 4, sqrt(2) / 2 ]);
            }

            translate([ 0 - 0.01, 11.2, 0 - 0.01 ]) {
                cube([ gpu_pcb_thickness + 0.02, 1.90, 7.45 + 0.02 ]);
            }
            ...
            translate([ 0 - 0.01, 12.15, 7.45 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 1.9);
            }
            ...
            translate([ 0 - 0.01, 84.3, 0 - 0.01 ]) {
                cube([ gpu_pcb_thickness + 0.02, 2.75, 7.605 + 0.02 ]);
            }
            translate([ 0 - 0.01, 85.675, 7.605 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 2.75);
            }
            ...
            translate([ 0 - 0.01, 87.05 - 0.01, 0 - 0.01 ]) {
                cube([ gpu_pcb_thickness + 0.02, 12.7 + 0.02, 2.95 + 0.02 ]);
            }
            translate([ 0 - 0.01, 98.35, 2.95 ]) rotate([ -30, 0, 0 ]) {
                cube([ gpu_pcb_thickness + 0.02, 1.4, 2.8 ]);
            }
            translate([ 0 - 0.01, 94.925 - 0.01, 7.95 ]) {
                cube([ gpu_pcb_thickness + 0.02, 4.825 + 0.02, 4.8 ]);
            }
            translate([ 0 - 0.01, 94.05, 8.825 ]) {
                cube([ gpu_pcb_thickness + 0.02, 1.75, 3.05 ]);
            }
            translate([ 0 - 0.01, 94.925, 8.825 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 1.75);
            }
            translate([ 0 - 0.01, 94.925, 11.875 ]) rotate([ 0, 90, 0 ]) {
                cylinder(h = gpu_pcb_thickness + 0.02, d = 1.75);
            }
        }
        color("#7F7F7F") translate([
            gpu_pcb_thickness, hole_base_x + (hole_dis_x - gpu_sidelen) / 2,
            hole_base_y + (hole_dis_y - gpu_sidelen) / 2
        ]) { // GPU Die
            cube([ gpu_thickness, gpu_sidelen, gpu_sidelen ]);
        }
        mem_x = 12;
        mem_y = 14;
        mem_t = 1.1;
        ...
        { // memory dies
            ...
            module mem_array() {
                translate([
                    0, (hole_dis_x - gpu_sidelen) / 2 - mem_space * 4,
                    (hole_dis_y - ((mem_x + mem_space) * 4 - mem_space)) / 2
                ]) {
                    rotate([ 180, 0, 0 ]) {
                        rotate([ 0, 90, 0 ]) {
                ...
                translate([
                    0, (hole_dis_x - ((mem_y + mem_space) * 4 - mem_space)) / 2,
                    (hole_dis_y - gpu_sidelen) / 2 - mem_x - mem_space * 4
                ]) {
                    rotate([ 90, 0, 0 ]) {
                        rotate([ 0, 90, 0 ]) {
                ...
                translate([
                    0,
                    gpu_sidelen + mem_y + (hole_dis_x - gpu_sidelen) / 2 +
                        mem_space * 4,
                    (hole_dis_y - ((mem_x + mem_space) * 4 - mem_space)) / 2
                ]) {
                    rotate([ 180, 0, 0 ]) {
            ...
            translate([ gpu_pcb_thickness, hole_base_x, hole_base_y ]) {
                mem_array();
            }
        ...
        { // 8 or 12 pin connectors
            translate([
                gpu_pcb_thickness,
                (gpu_pcb_length - ((molex_y + molex_space) * 3 - molex_space)) / 2,
                gpu_pcb_height -
                molex_x
            ]) {
                rotate([ 90, 0, 0 ]) {
        ...
        translate([ gpu_pcb_thickness, 14.7, (choke_x + choke_space) * 14 + 4 ]) { // vrm left
            { // mos array
                translate([ 0, 0, 0 ]) {
                    rotate([ 0, 90, 0 ]) {
            ...
            { // caps
                ...
                translate([
                    -gpu_pcb_thickness - cap_t, mos_y + cap_space + choke_y + cap_space, 0
                ]) {
                    rotate([ 0, 90, 0 ]) {
                        lineup(24, cap_x + cap_space) {
                            color("#7F7F7F") cube([ cap_x, cap_y, cap_t ]);
        ...
        translate([ gpu_pcb_thickness, gpu_pcb_length - 8, 0 ]) { // vrm right
            rotate([ 180, 0, 0 ]) {
                {// mos array
                ...
                { // caps
                    ...
                    translate([
                        -gpu_pcb_thickness - cap_t, mos_y + cap_space + choke_y + cap_space, -
                        mos_space
                    ]) {
                        rotate([ 0, 90, 0 ]) {
                            lineup(24, cap_x + cap_space) {
    ...
    module io_bracket(tab = false) {
        module mounting_tab() {
            difference() {
                ...
                translate([ 0 - 0.01, 7.95 - 1.27 / 2, 1.27 / 2 ])
                    rotate([ 0, 90, 0 ]) {
                    difference() {
        ...
        translate([ 18.42 - 1.27, -1.9 + bracket_thickness, 92.11 ]) {
            rotate([ 0, 0, 180 ]) {
                translate([ 0, bracket_thickness, 0 ]) difference() {
                    ...
                    difference() {
                        translate([ 2.54 - 0.01, 7.62 - 0.01, 0 - 0.01 ]) {
                            cube(
                                [ 3.81 + 0.02, 3.81 + 0.02, bracket_thickness + 0.02 ]);
                        }
                    ...
                    rotate([ 0, 90, 0 ]) {
                        intersection() {
                            ...
                            translate(
                                ...
                                cube([ bracket_thickness, bracket_thickness, 19.05 ]);
                            }
                        }
                    }
                }
                ...
                rotate([ -90, 0, 0 ]) {
                    difference() {
                        cube([ 21.59, 114.95 - bracket_thickness, bracket_thickness ]);
                        ...
                        if (tab) {
                            // long side shift cutout
                            translate([ 0 - 0.01, 0 - 0.01, 0 - 0.01 ]) { 
                        ...
                        translate([ 0 - 0.01, 0, 0 - 0.01 ]) { // bottom slope
                            linear_extrude(bracket_thickness + 0.02)  {
                                polygon([
                    ...
                    // be 5.07mm
                    translate([ 0, 114.95 - bracket_thickness, 0 ]) rotate([ 5, 0, 0 ]) union() {
                    ...
                    if (tab) {
                        // mounting tabs
                        translate([
                            18.42 - 1.27, 10.11 - 3.98, -12.57 + bracket_thickness
                        ]) {
                            mounting_tab();
                        }
                        translate([
                            18.42 - 1.27, 10.11 - 3.98 + 85.4, -12.57 + bracket_thickness
                        ]) {
                            mounting_tab();
                        }
                    }
    ...
    module cooler() {
        module mounting_screws() {
            translate([ screw_length / 2 - 1, 0, 0 ]) {
                ...
                translate(
                    [ 0, hole_base_x + hole_dis_x, hole_base_y + hole_dis_y ]) {
                    rotate([ 0, 90, 0 ]) screw_thread(screw_length, 3, 0.5);
                }
            }
        }
        screw_length = 8;
        difference() {
            translate([ gpu_pcb_thickness + gpu_thickness - 2, hole_base_x - 8, 4 ]) {
                color("#AFAFAF") cube(
                    [ 6 - 0.01, hole_dis_x + 16, hole_dis_y + (hole_base_y)*2 ]);
            }
            mounting_screws();
        }
        ...
        color("#AFAFAF") difference() {
            translate([ gpu_pcb_thickness + gpu_thickness + 2, 10, 4 ]) {
                if ($preview) {
                    cube([ pci_socket_distance * slots - 16, gpu_pcb_length - 10, gpu_pcb_height ]);
                } else {
                    stackup(floor(gpu_pcb_height) / 1.625, 1.625) {
                        cube([ pci_socket_distance * slots - 16, gpu_pcb_length - 10, 0.6 ]);
                    }
                }
                cube([ 2, gpu_pcb_length - 10, gpu_pcb_height - 1.625 ]);
            }
            translate(
                [ gpu_pcb_thickness, (gpu_pcb_length - 40.8) / 2 - 2, gpu_pcb_height - 13.3 ]) {
                cube([ 20, 40.8 + 4, 20 ]);
            }
            translate([
                gpu_pcb_thickness + gpu_thickness + pci_socket_distance * slots - 16 + 2 - 10 + 0.02, 
                gpu_pcb_length / 2, 
                gpu_pcb_height / 2 + 3 ]
            ) rotate([0, 90, 0]) {
                cylinder(h = 10, d = 120);
        ...
        translate([ pci_socket_distance * slots - 10, 
                    gpu_pcb_length / 2 - 118 / 2, 
                    gpu_pcb_height / 2 - 118 / 2 + 3 ]) {
            rotate([ 0, -90, 0 ]) {
                fan(size = 118, thickness = 10, blade = 9, shroud = false);
            }
        }
    ...
    module back_plate() {
        color("#AFAFAF") translate([ -2.67, 0, 0 ]) {
            cube([ 2.67 - 1.1, gpu_pcb_length, gpu_pcb_height ]);
        }
    }

    translate([ -gpu_pcb_thickness / 2, -57.15, 0 ]) {
        pcb();
        color("#A0A0A0") union() {
            io_bracket(tab = true);
            if (slots > 1) {
                translate([ pci_socket_distance, 0, 0 ]) {
                    lineup(slots - 1, pci_socket_distance) {
                        io_bracket();
                    };
                }
            }
