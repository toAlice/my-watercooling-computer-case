...
translate([ width - (ext_sidelen + mobo_clearance), 
            ext_sidelen + alu_thickness + rad_depth + rad_clearance, 
    ...
    if (mobo_ff != "mITX" && mobo_ff != "mDTX") 
        translate([ -pci_to_mobo - mobo_thickness,
                    pci_socket_to_top + pci_socket_distance * (pcie_shift + 3),
                    -pci_socket_indent ]) {
            rotate([ -90, 0, 0 ]) {
                rotate([ 0, -90, 0 ]) {
                    gpu();
...
if (mobo_ff != "mITX" && mobo_ff != "mDTX") {
    translate([ width - ext_sidelen - psu_atx_height - psu_bottom_clearance, 
                ext_sidelen + rad_depth 
                        + rad_clearance + screw_row_2_to_top 
...
if (mobo_ff != "mITX" && mobo_ff != "mDTX") 
    translate([ ext_sidelen,
                rad_depth + rad_clearance + screw_row_2_to_top 
                    - ext_sidelen / 2,
                unit_space ]) {
...
translate([ pump_mount_size + ext_sidelen, 
            rad_depth + rad_clearance + screw_row_2_to_top + ext_sidelen 
...
translate([ ext_sidelen,
            ...
            + rad_clearance + pci_socket_to_top 
            + pci_socket_distance - gpu_pcb_thickness / 2 
